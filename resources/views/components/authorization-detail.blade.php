    ...
    <div class="ndb:flex ndb:flex-col">
      <x-newdebugbar::inspector-detail-header data-ndb-authorization-header>
        ...
        <x-slot:identity data-ndb-authorization-identity>
          <dl class="ndb:space-y-2">
            <div
              class="ndb:grid ndb:grid-cols-[4.75rem_minmax(0,1fr)] ndb:items-baseline ndb:gap-2"
            >
              <dt class="ndb:text-[11px] ndb:font-semibold ndb:text-zinc-400">
                Actor
              </dt>
      ...
      >
        <x-newdebugbar::filter-tabs
          label="Authorization decision detail"
          class="ndb:min-w-0"
        >
      ...
      <div class="ndb:p-4">
        ...
        >
          ...
          >
            ...
            <p
              ...
              x-text="
                selectedAuthorizationDecision.result_message ??
          ...
          <div data-ndb-authorization-actor-detail>
            <p class="ndb:mb-2 ndb:text-[11px] ndb:font-bold ndb:uppercase ndb:tracking-wider ndb:text-zinc-400">Actor</p>
            <div
              class="ndb:rounded-xl ndb:border ndb:border-zinc-200/90 ndb:dark:border-zinc-800"
            >
              <dl
              ...
              >
                ...
                <div
                  x-show.important="
                    selectedAuthorizationDecision.actor_identifier !== null
                  "
                  class="ndb:grid ndb:gap-1 ndb:px-3 ndb:py-2.5 ndb:sm:grid-cols-[7rem_minmax(0,1fr)] ndb:sm:gap-4"
                >
                  <dt
                    class="ndb:text-[11px] ndb:font-semibold ndb:text-zinc-400"
                    x-text="
                      selectedAuthorizationDecision.actor_identifier_name ??
                      'Identifier'
                    "
                  ></dt>
                  <dd
          ...
          <div data-ndb-authorization-arguments-detail>
            <p class="ndb:mb-2 ndb:text-[11px] ndb:font-bold ndb:uppercase ndb:tracking-wider ndb:text-zinc-400">Ordered arguments</p>
            <p
              x-show.important="
            ...
            >No target or additional arguments were supplied.</p>
            <div
              x-show.important="
                selectedAuthorizationDecision.arguments.length > 0
              "
            ...
            >
              ...
              >
                <div
                  class="ndb:grid ndb:gap-1 ndb:px-3 ndb:py-2.5 ndb:sm:grid-cols-[7rem_minmax(0,1fr)] ndb:sm:gap-4"
                >
                  <p class="ndb:text-[11px] ndb:font-semibold ndb:text-zinc-400" x-text="
                      argument.role_label
                    "></p>
                  <div class="ndb:min-w-0">
                    <p class="ndb:break-words ndb:text-xs ndb:font-bold" x-text="
                        argument.label
                      "></p>
                    <code
          ...
          <div data-ndb-authorization-handler-detail>
            <p class="ndb:mb-2 ndb:text-[11px] ndb:font-bold ndb:uppercase ndb:tracking-wider ndb:text-zinc-400">Configured handler</p>
            <div
              class="ndb:flex ndb:min-w-0 ndb:items-start ndb:justify-between ndb:gap-3 ndb:rounded-xl ndb:border ndb:border-zinc-200/90 ndb:px-3 ndb:py-3 ndb:dark:border-zinc-800"
            >
              <div class="ndb:min-w-0">
                <code
                ...
                ></code>
                <p class="ndb:mt-1 ndb:text-[11px] ndb:capitalize ndb:text-zinc-400" x-text="
                    selectedAuthorizationDecision.handler_kind
                  "></p>
              </div>
              <button
                type="button"
          ...
          <div
            class="ndb:rounded-xl ndb:bg-indigo-50/70 ndb:p-3 ndb:dark:bg-indigo-950/25"
          >
        ...
        >
          ...
          <div>
            <p class="ndb:mb-2 ndb:text-[11px] ndb:font-bold ndb:uppercase ndb:tracking-wider ndb:text-zinc-400">Handler definition</p>
            <div
              class="ndb:flex ndb:min-w-0 ndb:items-start ndb:justify-between ndb:gap-3 ndb:rounded-xl ndb:bg-zinc-100/75 ndb:p-3 ndb:dark:bg-zinc-900"
            >
              <div class="ndb:min-w-0">
                <code
                  class="ndb:block ndb:break-words ndb:font-mono ndb:text-[11px] ndb:font-bold"
              ...
              <button
                x-show.important="
                  selectedAuthorizationDecision.handler_source_label !== null
                "
                type="button"
                data-ndb-authorization-copy-handler-source
                @click="
                  copyText(selectedAuthorizationDecision.handler_source_label)
                "
          ...
          <div>
            <p class="ndb:mb-2 ndb:text-[11px] ndb:font-bold ndb:uppercase ndb:tracking-wider ndb:text-zinc-400">Evaluation origin</p>
            <div
              class="ndb:flex ndb:min-w-0 ndb:items-start ndb:justify-between ndb:gap-3 ndb:rounded-xl ndb:bg-zinc-100/75 ndb:p-3 ndb:dark:bg-zinc-900"
            >
              <code
              ...
              <button
                x-show.important="
                  selectedAuthorizationDecision.callsite_label !== null
                "
                type="button"
          ...
          <div>
            <p class="ndb:mb-2 ndb:text-[11px] ndb:font-bold ndb:uppercase ndb:tracking-wider ndb:text-zinc-400">Application stack</p>
            <p
              x-show.important="
                selectedAuthorizationDecision.stack.length === 0
              "
              class="ndb:text-xs ndb:text-zinc-500 ndb:dark:text-zinc-400"
            >No application stack was captured.</p>
            <div
              x-show.important="selectedAuthorizationDecision.stack.length > 0"
              class="ndb:divide-y ndb:divide-zinc-200/90 ndb:dark:divide-zinc-800"
            >
              <template
                x-for="(frame, index) in selectedAuthorizationDecision.stack"
                :key="index"
              >
          ...
          <p class="ndb:rounded-xl ndb:border ndb:border-zinc-200/90 ndb:px-3 ndb:py-3 ndb:text-xs ndb:leading-5 ndb:text-zinc-500 ndb:dark:border-zinc-800 ndb:dark:text-zinc-400">Laravel reports the final result. It does not identify whether a Gate before or after hook made the decision.</p>
        </div>
      </div>
    </div>
  </template>
