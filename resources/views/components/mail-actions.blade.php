...
>
    ...
    >
        ...
        >
            <span
                class="ndb:flex ndb:size-8 ndb:shrink-0 ndb:items-center ndb:justify-center ndb:rounded-lg ndb:bg-indigo-50 ndb:text-indigo-600 ndb:dark:bg-indigo-950/60 ndb:dark:text-indigo-300"
            >
            ...
            <span class="ndb:min-w-0">
                ...
                <span class="ndb:mt-0.5 ndb:block ndb:text-[11px] ndb:text-zinc-400"
                    >Follow the linked queue activity</span
                >
            </span>
        </button>
        <a
        ...
        >
            ...
            <span class="ndb:min-w-0">
                ...
                <span class="ndb:mt-0.5 ndb:block ndb:text-[11px] ndb:text-zinc-400"
                    >Open the rendered message in a new tab</span
                >
            </span>
        </a>
        <a
        ...
        >
            <span
                class="ndb:flex ndb:size-8 ndb:shrink-0 ndb:items-center ndb:justify-center ndb:rounded-lg ndb:bg-emerald-50 ndb:text-emerald-600 ndb:dark:bg-emerald-950/60 ndb:dark:text-emerald-300"
            >
            ...
            <span class="ndb:min-w-0">
                ...
                <span class="ndb:mt-0.5 ndb:block ndb:text-[11px] ndb:text-zinc-400"
                    >Save the raw captured message</span
                >
            </span>
        </a>
    </x-newdebugbar::popover-surface>
