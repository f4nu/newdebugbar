                ...
                >
                    @foreach ($httpItems as $item)
                        <button
                            ...
                            class="ndb:grid ndb:w-full ndb:grid-cols-[auto_minmax(0,1fr)_auto] ndb:items-center ndb:gap-x-1 ndb:gap-y-0.5 ndb:px-3 ndb:py-2.5 ndb:text-left ndb:transition-colors ndb:focus-visible:relative ndb:focus-visible:z-10 ndb:focus-visible:outline-2 ndb:focus-visible:outline-indigo-500"
                        >
                            <span
                            ...
                            <span
                                ...
                                class="ndb:min-w-0 ndb:justify-self-stretch ndb:truncate ndb:text-left ndb:text-xs ndb:font-bold"
                            >{{ $item['host'] }}</span>
                            <span
                            ...
                            <span class="ndb:col-start-2 ndb:min-w-0 ndb:justify-self-stretch ndb:truncate ndb:text-left ndb:text-[11px] ndb:text-zinc-500 ndb:dark:text-zinc-400">{{ $item['path'] }}{{ $item['query'] !== null ? '?'.$item['query'] : '' }}</span>
                            <span
